...
export default function PrivacyScreen() {
  ...
  return (
    ...
    >
      ...
      <Section title="권한 사용">
        카메라는 조과 촬영에, 사진 보관함은 출조 커버·프로필 사진 선택과 사용자가
        요청한 조과 사진 저장에, 위치는 사용자가 허용한 경우 촬영 시점 조과 인증에만
        사용합니다. 앱은 사용자가 ‘사진 저장’을 누른 조과 사진만 사진 앱에 추가하며,
        사진 앱의 다른 사진을 읽지 않습니다. 위치를 허용하지 않아도 사진 분석과 조과
        기록을 계속할 수 있습니다.
      </Section>
