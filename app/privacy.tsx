  ...
  return (
    ...
    >
      ...
      <Section title="수집하는 정보">
        ...
        사진 보관함에서 조과 사진을 선택한 경우 해당 사진에 포함된 촬영 위치와
        시각, 앱 버전·운영체제와 기능 이용 기록(AI 처리 결과, 도감·카드 열람,
      ...
      <Section title="권한 사용">
        카메라는 조과 촬영에, 사진 보관함은 사용자가 선택한 조과·출조 커버·프로필
        사진 접근과 사용자가 요청한 조과 사진 저장에 사용합니다. 조과 사진을
        선택하면 해당 사진의 촬영 위치와 시각을 연안 인증에 사용하며, 선택하지 않은
        사진의 내용이나 위치는 수집하지 않습니다. 기기 위치는 사용자가 허용한 경우
        인앱 촬영 시점 조과 인증에만 사용합니다. 위치가 없어도 사진 분석과 일반 기록
        저장을 계속할 수 있습니다.
      </Section>
